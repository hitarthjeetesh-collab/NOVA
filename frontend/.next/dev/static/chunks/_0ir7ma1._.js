...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$engineering$2f$architecture$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/engineering/architecture/data.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const initialNodes = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$engineering$2f$architecture$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialSystems"].map((system)=>({
        id: system.id,
        type: "system",
        position: initialPositions[system.id] ?? {
            x: 0,
            y: 0
        },
        data: {
...
const initialEdges = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$engineering$2f$architecture$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialConnections"].map((connection)=>({
        id: connection.id,
        source: connection.sourceId,
        target: connection.targetId,
        label: connection.protocol ? `${connection.type} · ${connection.protocol}` : connection.type,
        data: {
...
function Architecture() {
   ...
   */ const deleteSystem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Architecture.useCallback[deleteSystem]": (nodeId)=>{
            ...
            const confirmed = window.confirm(`Delete "${node.data.name}"?`);
            if (!confirmed) {
                return;
            }
            setNodes({
                "Architecture.useCallback[deleteSystem]": (current)=>current.filter({
                        "Architecture.useCallback[deleteSystem]": (item)=>item.id !== nodeId
                    }["Architecture.useCallback[deleteSystem]"])
            }["Architecture.useCallback[deleteSystem]"]);
            setEdges({
                "Architecture.useCallback[deleteSystem]": (current)=>current.filter({
                        "Architecture.useCallback[deleteSystem]": (edge)=>edge.source !== nodeId && edge.target !== nodeId
                    }["Architecture.useCallback[deleteSystem]"])
            }["Architecture.useCallback[deleteSystem]"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "Drag systems · Connect handles"
                    }, void 0, false, {
                        fileName: "[project]/components/engineering/Architecture.tsx",
                        lineNumber: 453,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$engineering$2f$ConnectionModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                sourceName: sourceNode?.data.name ?? "Unknown System",
                targetName: targetNode?.data.name ?? "Unknown System",
                onClose: ()=>{
                    setPendingConnection(null);
                    setConnectionModalOpen(false);
                },
...
_s(Architecture, "4RJVZC7qE4MA2TbthBR7J3XFf2c=");
_c = Architecture;
var _c;
...
_s(SystemModal, "BD/0wqH08osrWByQ9LA1Nbdwvsw=");
_c = SystemModal;
var _c;
...
"[project]/components/engineering/architecture/data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const initialSystems = [
    {
        ...
        name: "ORION",
        category: "System",
        description: "Modular wearable engineering platform.",
        status: "Concept",
        parameters: []
    },
    {
    ...
    },
    {
        ...
        category: "Power",
        description: "Monitors and protects the battery.",
        status: "Concept",
        parentId: "power",
        parameters: []
    },
    {
        ...
        category: "Sensors",
        description: "Collects environmental and motion data.",
        status: "Concept",
        parentId: "orion",
        parameters: []
    },
    ...
    },
    {
        ...
        name: "LiDAR",
        category: "Sensors",
        description: "Provides depth and ranging information.",
        status: "Concept",
        parentId: "perception",
        parameters: []
    },
    {
        ...
        name: "IMU",
        category: "Sensors",
        description: "Measures acceleration and orientation.",
        status: "Concept",
        parentId: "perception",
        parameters: []
    },
    ...
    },
    {
        ...
        name: "Jetson Orin NX",
        category: "Computing",
        description: "Main onboard computing platform.",
        status: "Designed",
        parentId: "computing",
        parameters: [
            {
    ...
    },
    {
        ...
        name: "AI System",
        category: "Software",
        description: "AI inference and intelligence subsystem.",
        status: "Concept",
        parentId: "computing",
        parameters: []
    },
...
const initialConnections = [
    {
        ...
        type: "power",
        protocol: "DC",
        description: "Battery supplies power to the power system."
    },
    {
        id: "power-computing",
        sourceId: "power",
        ...
        type: "power",
        protocol: "24V DC",
        description: "Power system supplies the computing system."
    },
    {
        id: "camera-jetson",
        sourceId: "camera",
        ...
        type: "sensor_data",
        protocol: "USB 3",
        description: "Camera feed sent to the Jetson."
    },
    {
        id: "lidar-jetson",
        sourceId: "lidar",
        ...
        type: "sensor_data",
        protocol: "Ethernet",
        description: "LiDAR data sent to the Jetson."
    },
    {
        id: "jetson-ai",
        sourceId: "jetson",
        ...
        type: "communication",
        protocol: "Internal",
        description: "AI inference runs on the Jetson."
    },
    {
        ...
        type: "control",
        protocol: "CAN",
        description: "Computing system sends control commands."
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
//# sourceMappingURL=_0ir7ma1._.js.map